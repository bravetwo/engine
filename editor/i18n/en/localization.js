...
module.exports = {
    ...
    button: {
        ...
        target:
            "reference to the Sprite as target's background. When the state of the target changes the sprite's color or sprite frame will be updated.",
    ...
    toggle: {
        ...
        target:
            "reference to the Sprite as Toggle's background. When the state of the button changes the sprite's color or sprite frame will be updated.",
        isChecked:
    ...
    widget: {
        ...
        bottom: 'Bottom edge position in pixels. This can be a percentage and a positive or negative value',
        left: 'Left edge position in pixels. This can be a percentage and a positive or negative value',
        right: 'Right edge position in pixels. This can be a percentage and a positive or negative value',
    ...
    richtext: {
        ...
        line_height: 'Line height, in points',
        image_atlas:
            'The image atlas for the img tag. For each src value in the img tag, there should be a valid sprite frame in the image atlas.',
        handleTouchEvent:
            'Once checked, the Rich Text will block all input events (mouse and touch) within the bounding box of the node, preventing the input from penetrating into the underlying node.',
    },
    UICoordinateTracker: {
        target: 'Target node',
    ...
    particle_system: {
        ...
        rotatePerS: 'Number of degrees to rotate a particle around the source pos per second and variation. Only available in Radius mode',
    ...
    physics: {
        ...
        physics_collider: {
            ...
            mouseRegion: "The node used to register touch event. If this is null, it will be the joint's node.",
            target: 'The target point. The mouse joint will move chosen rigid body to target point.',
    ...
    block_input_events: {
        brief_help:
            'This component will block all input events, \npreventing the input from penetrating to other nodes below the screen, \ntypically for the background of the top-level UI of the screen.',
    },
    tiledtile: {
    ...
    physics3d: {
        ...
        collider: {
            ...
            mesh_convex: 'Whether to use convex hull approximation instead, \nthe number of vertices should be less than 255, \nand the dynamics can be supported after turning on',
